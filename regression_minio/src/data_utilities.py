...
def get_data(client):
    ...
    try:
        ...
        # print(f"Object '{object_name}' already exists in bucket '{bucket}'.")
    except S3Error as e:
        if e.code == "NoSuchKey":
            ...
            # print(f"Object '{object_name}' added to bucket '{bucket}'.")
        else:
